              ...
              <div className="space-y-4">
                <div>
                  ...
                  <DatePicker
                    ...
                    date={tempStartDate}
                    onDateChange={(date) =>
                      setTempFilters({ ...tempFilters, startDate: toDateString(date) })
                    }
                  />
                </div>
                <div>
                  ...
                  <DatePicker
                    ...
                    date={tempEndDate}
                    onDateChange={(date) =>
                      setTempFilters({ ...tempFilters, endDate: toDateString(date) })
                    }
                  />
                </div>
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setTempFilters({ ...tempFilters, numBeds: value || undefined })
                    }
                    options={BEDS_OPTIONS}
                    placeholder="Any Beds"
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setTempFilters({ ...tempFilters, numBaths: value || undefined })
                    }
                    options={BATHS_OPTIONS}
                    placeholder="Any Baths"
                    triggerClassName="w-full"
